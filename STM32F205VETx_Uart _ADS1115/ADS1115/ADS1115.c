...
static void ADS1115_ReadRawData(ADS1115_InitTypeDefine *ADS1115_InitStruct)
{
...
void ADS1115_ScanChannel(ADS1115_InitTypeDefine *ADS1115_InitStruct,ADS1115_CHANNEL ch)
{
	...
	case ADS1115_CHANNEL3:
		...
		break;
	case ADS1115_Differ_01:
		ADS1115_InitStruct->MUX = ADS1115_MUX_Differ_01;
		break;
		case ADS1115_Differ_03:
		ADS1115_InitStruct->MUX = ADS1115_MUX_Differ_03;
		break;
			case ADS1115_Differ_13:
		ADS1115_InitStruct->MUX = ADS1115_MUX_Differ_13;
		break;
	case ADS1115_Differ_23:
		ADS1115_InitStruct->MUX = ADS1115_MUX_Differ_23;
		break;
	default:
		break;
	}
 ...
 * @retval 返回经过计算的电压值
 */
static void ADS1115_RawDataToVoltage(ADS1115_InitTypeDefine *ADS1115_InitStruct)
{
...
void ADS1115_RefreshAllChannel(ADS1115_InitTypeDefine *ADS1115_InitStruct)
{
	...
	//结束采样后切换至下一通道
	ADS1115_ScanChannel(ADS1115_InitStruct,ADS1115_InitStruct->CHANNEL);
}
